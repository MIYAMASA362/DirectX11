...
public:
	...
	void Load() override
	{
		...
		object->AddComponent<CameraMouse>();
		{
			...
			{
				Sky->transform.get()->localScale(Vector3::one()*50.0f);
			...
			//{
			//	wall->transform.get()->localScale(Vector3::one()*50.0f);
			...
			//{
			//	Field->transform.get()->position(Vector3::up() * 3.0f);
			//	Field->transform.get()->localScale(Vector3::one()*50.0f);
			...
			//{
			//	Field2->transform.get()->position(Vector3::down()*10.0f);
			//	Field2->transform.get()->localScale(Vector3::one()*50.0f);
			...
			//{
			//	block->transform.get()->position(Vector3::up() * 10.0f);
			//	block->transform.get()->localScale(Vector3(1.0f,0.0f,1.0f) * 10.0f + Vector3::up());
			...
			//{
			//	pModel->transform.get()->position(Vector3::up()*4.0f);
			//	pModel->transform.get()->localScale(Vector3::one());
			...
			//{
			//	billboard->transform.get()->localScale(Vector3::one()*1.0f);
			//	{
